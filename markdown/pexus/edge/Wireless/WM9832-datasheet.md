...
WM9832 是 **Pexus Edge** 无线远程 I/O 系列中的一款 2.4G 私有协议无线数字量模块，提供 **4 路可配置数字输入/输出（IO1~IO4）+ 4 路数字输出（O5~O8）**，共 8 路信号通道。模块支持 DC 9~36V 工业宽压供电，内置断电后备续航电路，外部主电断电后，后备输出及无线通信可维持 ≥3s，可适配碳刷设备短时供电不稳、瞬时掉电等工业工况。
...
本模块为 4 路可配置数字输入输出（IO1~IO4）+ 4 路数字输出（O5~O8）无线 IO 模块，支持 DC 9~36V 宽压供电，内置断电后备续航电路，外部主电断电后，后备输出及无线通信可维持 ≥3s。
...
| 11 | OUT 后备 | 断电后备输出 | 主电断电后持续供电，配合无线通信维持 ≥3s 工作时长 |
...
- **供电与后备电路**：DC 9~36V 工业宽压供电；内置储能后备电路，针对碳刷设备瞬时掉电、供电波动工况，主电断开后可保障后备输出供电、无线通信持续工作 ≥3 秒。
...
- 后备输出为短时续航功能，仅用于工况容错适配，不支持长期带载工作。
:::
